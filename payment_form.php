...
echo "<form action='payment (1).php'>";
echo "<input type='hidden' value='" . $_GET['tr_id'] . "' name='tr_id'>";
...
echo "</tr>";
echo "<th>PIN</th>";
echo "<th><input type='number' name='pin' placeholder='****'></th>";
echo "</tr>";
echo "<tr>";
...
echo "<tr>";
echo "<th>Cost</th>";
echo "<td><input type='number' name='cost' value='". $_GET['Cost'] . "'></td>";
echo "</tr>";
echo "<tr>";
